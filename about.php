...
<main>
	<div class="text-white img-bg">
        <img src="./img.jpg" style='opacity:0.2;width:120%;min-width:1280px;height:auto;min-height:100%;position:absolute;top:-70%;left:-20%' lm me===fgfuwreIGAhwgiv=alt="Background">
		<div>
