                ...
                <div id="accordion">
                  ...
                  <div class="card">
                    ...
                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                      <div class="card-body">
                        These are some basic prerequisites for this program: <br>1. You are self driven and motivated to learn. Participation in this program requires consistently meeting the deadlines.<br>
2. You have access to a computer with broadband connection, on which you will install a professional code/text editor.<br>
3. You are willing to contribute to the success of the program, including collaborating with fellow interns. <br>
