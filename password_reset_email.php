  ...
  <div style="background-color:#ffffff;">
                        ...
                        <tbody>
                          <tr>
                            <td style="width:150px;">
                              ...
                              <img alt="HNG logo" height="150" src="https://res.cloudinary.com/damilare1957/image/upload/v1525088492/logo.png" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="150" />
    ...
    <div style="Margin:0px auto;max-width:600px;">
      ...
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
        <tbody>
          <tr>
            <td style="direction:ltr;font-size:0px;padding:20px 0;padding-top:100;text-align:center;vertical-align:top;">
              <!--[if mso | IE]>
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      ...
                      <div style="font-family:Lato;font-size:15px;letter-spacing:0.48px;line-height:20x;text-align:center;color:#000000;">
                        ...
                        To get a new password reset link, visit <a href="http://revenge.hng.fun/passwordreset.php?token=<?= htmlspecialchars($token) ?>"><span style="color:#2F80ED">here</span></a>
                      </div>
