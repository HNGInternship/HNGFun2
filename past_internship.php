        ...
        <div class="tab-content" id="v-pills-tabContent">
          ...
          <div class="tab-pane fade show active" id="v-pills-tab-1-label" role="tabpanel" aria-labelledby="v-pills-tab-1">
            ...
            <p style="text-align: justify; font-size: 1rem; line-height: 170%" class="text-muted">Sept 1, 2017, the third edition of the prestigious hotels.ng remote internship started with over 1000 remote
              ...
              in Akwa Ibom state would be available for all interns within the region to use. This move ameliorated the issues
              of lack of power and internet for interns in that region and led to an increase in the levels of productivity
              of interns in that region. Of the over 1000 remote interns that signed up, only 100 actually made it to the
              finals. A lot of tools were built during the internship (e.g. Hotels.ng Android App, an Internal Financial
          ...
          <div class="tab-pane fade" id="v-pills-tab-2-label" role="tabpanel" aria-labelledby="v-pills-tab-2">
            ...
            <p style="text-align: justify; font-size: 1rem; line-height: 170%" class="text-muted">January 3, 2017, Mark Essien (CEO, Hotels.ng) hinted the commencement of Hotels.ng remote internship programme
              in a tweet. That tweet fulfilled the promise of continuity and growth, and the pledge to help develop the Nigerian
              tech community, it opened up doors once more to people eager to learn and develop themselves, and set up the
              remote internship as a hotels.ng tradition. Not look after that tweet, the second edition of Hotels.ng Internship
              started, this time with over 800 remote interns on the Slack Workspace. It was as exciting and educative as
              the first edition and people that did not make it to the end of the first edition had another chance to prove
