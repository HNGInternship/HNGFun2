...
class Paginator {
    ...
    public function createLinks( $links, $list_class ) 
    {
        ...
        '<li class="' . $class . '"><a class="page-link" href="">&laquo;</a></li>' : //remove link from previous button
        '<li class="' . $class . '"><a class="page-link" href="?limit=' . $this->_limit . '&page=' . ( $this->_page - 1 ) . '">&laquo;</a></li>';

        $html .= $previous_page;

        if ( $start > 1 ) { //print ... before (previous <<< link)
            $html .= '<li><a class="page-link" href="?limit=' . $this->_limit . '&page=1">1</a></li>'; //print first page link
...
//////////////////////////////////////////////////////////////////////////
        ...
        if ( $end < $last ) { //print ... before next page (>>> link)
            ...
            $html .= '<li><a class="page-link" href="?limit=' . $this->_limit . '&page=' . $last . '">' . $last . '</a></li>'; //print last page link
        }
        ...
        '<li class="' . $class . '"><a class="page-link" href="">&raquo;</a></li>' : //remove link from next button
        '<li class="' . $class . '"><a class="page-link" href="?limit=' . $this->_limit . '&page=' . ( $this->_page + 1 ) . '">&raquo;</a></li>';
