        ...
        <div class="row">
            <div id="left-pan" class="col-md-6">
                <div id="shield-invite-lpanel">
                    ...
                    <a href="hng.fun/invite" class="button--style-red">Click!</a>
                </div>
            </div>
            <div id="right-pan" class="col-md-6">
                <div id="shield-envelope">
                    <div class="shield-circle">
                        ...
                        <img src="img/invite/small-envelope.png" alt="" id="shield-sm-env">    
                        <svg width="30" height="31" viewBox="0 0 30 45" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g id="Canvas" fill="none">
                        <g id="Ellipse 2.1">
                        <circle cx="3.63898" cy="29.63898" r="9.63898" transform="translate(0.223633 0.931274)" fill="#EB5757" fill-opacity="0.5"/>
                        </g>
                        </g>
                        </svg>
