        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              ...
              <h3 class="mb-3">Ready to Work Remotely</h3>
              <p class="text-muted mb-0">Work With You From Anywhere In The World</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              ...
              <p class="text-muted mb-0">Time is One of the most Important Factors. I never Disappoint</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              <i class="fa fa-4x fa-heart text-primary mb-3 sr-icons"></i>
              <h3 class="mb-3">End Up Happy & Satisfied</h3>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 ml-auto text-center">
            ...
            <p>+234-90-766-218-91</p>
          </div>
          <div class="col-lg-4 mr-auto text-center">
            <i class="fa fa-envelope-o fa-3x mb-3 sr-contact"></i>
            <p>
              <a href="mailto:thankgodegbo@gmail.com">feedback@ThaTruth.com</a>
            </p>
