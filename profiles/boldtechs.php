...
<div class="card">
    <img src="http://res.cloudinary.com/boldtechs/image/upload/v1523952242/1.jpg" alt="picture" style="width:100%">
    <h3 class="mt">Saheed Lawal</h3>
    <h6> Designer</h6>
    <h6 style="color: #007BFF"> slack username: boldtechs</h6>
    <p><button><a href="www.hngfun/boldtechs.php"></a>  HNG 4.0 Intern</button></p>
 </div>
 <div class="chatbox"> 
