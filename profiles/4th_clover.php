...
<?php
    ...
    $conn = new PDO('mysql:host=localhost;dbname=cdcol', 'root', '');
...
function getAnswer( $input ) {
    ...
    // if ( empty( $result ) ) {
    //     return "<div id='result'>Sorry, 'train: question # answer # password'</div>";
    // } else {
       ...
       <div></div>
        <div class='bot-message2'>
          ...
          <div class = "myinput" id= "myinput">
            <form action="val.php" method="post" name = "chatinput" id = "chatinput">
              <input type="text" name="user-input" placeholder="Ask me anything" class = "dinput" id ="user-input">
               <button type="button" class="mysend" id = "chatinput" name = "chatinput" onclick="checkit()">Send</button> 
            </form>
...
//<![CDATA[
    ...
    function checkit(){
      var str = document.getElementById('user-input').value;
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
              document.getElementById('user-input').value= this.responseText;
            }
        };
        xmlhttp.open("GET", "val.php?chatinput="+str, true);
        xmlhttp.send();
    //]]>
    // function welcome(){
