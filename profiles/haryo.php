    ...
    <div class="page-content color-dark profile-scope-1zgKV" data-reactroot="">
        ...
        <main>
            ...
            <div class="profile small profile_view-scope-1Shwh">
                <style>
                body {
					background-color: ##7e749c;
                    background: -webkit-linear-gradient(315deg, ##7e749c 0%, ##7e749c 30%, #ffffff 100%) fixed;
                    background: linear-gradient(135deg, ##7e749c 0%, ##7e749c 30%, #ffffff 100%) fixed;
                     }
                </style>
