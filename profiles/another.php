...
<section id="profile">
    ...
    <div class="ima">
            ...
            <img src="http://res.cloudinary.com/chidinma/image/upload/v1525710987/IMG_20161231_171852.jpg"  width="200" height="200" alt="profile" class="rotateimg180">
        <!-- </span> -->
       <p>          Tech enthusiast, Intern @HNGInternship, <br/> web development student.<br/>
                    email: <u>chypearlnel@gmail.com</u><br/>
                     Phone no: 09022181787
              <p>
              <b> NAME:</b> Chidinma Orji<br>
               <b/>OCCUPATION:</b> Web Designer to be<br>
              <b> HOBBIES:</b> My phone
            </p>
 </div>        
        <div class="container">
            <div id='chat-area'>
            ...
            <div class="botbot"> 
                <div class="font" style="color: rgb(13, 36, 53); text-align: center;"> NMA'S BOT</div>
        ...
        <!-- <div class="pro ">
            ...
            <span class="input-group-addon" id="basic-addon1">  
                <a href="https://twitter.com/Pearlynma" class="fab fa-twitter-square" style=" font-size: 30px;" > </a>
            </span>   
    ...
    <script>
            function loadDoc() {
                ...
                xhttp.open("POST", "/profiles/another.php", true);
