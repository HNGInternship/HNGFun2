    ...
    if($_SERVER['REQUEST_METHOD'] === "POST"){
        ...
        if(isset($_POST['message']) && $_POST['message'] != '') {
            ...
            switch (strtolower($question) ) {
                case 'about bot':
                    {
                        echo json_encode(['message' => 'Hamzat. Version: 1.0']);
                        break;
    ...
    <div class="row top-buffer">
        <div class="col-lg-6 col-sm-6">
            ...
            <div class="card hovercard">
                <div class="avatar">
                    <img alt="Hamzat Image" src="http://res.cloudinary.com/hamtech/image/upload/v1524671205/ibrahim.jpg">
                </div>

                <div class="bottom">
                    <br>
                    <br>
                    <h1 target="_blank" href="#"><?php echo $name; ?></h1>
                    <h1 target="_blank" href="#"><?php echo $username; ?></h1>

                    <h1 class="desc">Backend Developer</h1>
                    <h1 class="desc">A Ml Lover</h1>
                    <h3 class="desc">Intern @HNG</h3>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        if (firstLoad === true && $('.chatbox').hasClass('hidden') === false) {
            ...
            var message1 = window.setTimeout(function(){
                var default_message = '<div class="chat self"><div class="user-photo"><img src=""></div> <div class="chat-message">Hello I\'m Hamzzy, <br> Let talk</div> </div>';
            ...
            var menu = window.setTimeout(function(){
                var menu_message ='<div class="chat self"> <div class="user-photo"><img alt="Hamzat " src=""></div> <div class="chat-message">Main Menu: <ul> <li>AboutBot</li> <li>Time</li> </ul> </div> </div>';
    ...
    function playMessageSound() {
        ...
        aSound.setAttribute('src', 'https://res.cloudinary.com/hamtech/video/upload/v1526909080/ping.mp3');
    ...
    $("#submitmsg").click(function() {
        ...
        if (clientmsg != '') {
            var msg='<div class="chat friend"><div class="user-photo"><img src=""></div> <div class="chat-message">'+
                clientmsg.replace(/\n/g, '<br />') +
                '</div></div>';
            ...
            $.ajax({
                ...
                success: function(response){
                    var received_message = '<div class="chat self"><div class="user-photo"></div> <div class="chat-message">'+
                        response.message
                        +'</div></div>';
