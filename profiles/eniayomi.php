...
<head>
	...
	<title>Portfolio | Oluwaseyi Oluwapelumi</title>
	<style type="text/css">
  ...
  z-index: -1;  
   ...
   /* position: fixed;*/
		height: 100vh;
				...
				background-image: url(http://res.cloudinary.com/eniayomi/image/upload/v1525687947/Wood_207.jpg);
				/*opacity: 50%;*/
	}
			#name-div{
...
<div class="ot oj-flex oj-flex-item oj-sm-only-flex-direction-column oj-md-only-flex-direction-column" >
 <div class="oj-sm-flex-1 oj-xl-web-padding-top oj-sm-web-padding-bottom oj-md-down-web-padding-start oj-lg-padding-2x-start oj-sm-web-padding-end oj-xl-6 oj-flex-item ">
  ...
  <div id="about-me">
    <div id="social-media">
        <ul>
        <li><a href="https://github.com/papuzzy"><i class="fa fa-github"></i></a></li>
        <li><a href="https://twitter.com/techteel"><i class="fa fa-twitter"></i></a></li>
       <li><a href="https://www.instagram.com/techteel/"><i class="fa fa-instagram"></i></a></li>
                </ul>
      </div>
    <p>I am a junior web developer. Want to chat, collaborate or hire me on a project, please feel free to contact me.</p>
    <div id="contact" align="center"><a href="mailto:nathanoluwaseyi@gmail.com">CONTACT</a></div>
