<?php
	...
	//Fetch User Details
	try {
	    $query = "SELECT * FROM interns_data WHERE username ='eniayomi'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(preg_replace('([\s]+)', ' ', trim(strtolower($question))) === 'aboutbot'){
      echo json_encode([
        'status' => 1,
        'answer' => "Hi dear! My name is Eny. EnyBot is currently in version 1.0 and it's built by -Oluwaseyi Oluwapelumi-"
      ]);
      return;
    };
...
<body>	
	<div class="flex-container">
		...
		<div class="content-containter">
			<img class="circle_img" src="http://res.cloudinary.com/eniayomi/image/upload/v1524007065/pe.png" atl="Eniayomi Photo" style="/**border-radius:50%; border:6px solid black; **/width:200px">				
			...
			<div class="link">
				<p><a href="wwww.techteel.com">www.techteel.com</a><br>Follow me:</p>
			</div>
		...
		<div class="chatbot-container">
			<div class="chat-header">
				<span>Eny Chatbot</span>
			</div>
			<div id="chat-body">
				<div class="bot_chat">
						<div class="message">Hello! My name is Eny.<br>You can ask me questions and get answers.<br>Type <span style="color: #FABF4B;"><strong> Aboutbot</strong></span> to know more about me.
						</div>
		...
		<div class="myfooter">	
			...
			<div style="text-align:center">
				...
				<span style="font-size:0.6em; "> This page is designed <strong>by <span style="color: #cc023b"> @Eniayomi </span> </strong>- HTML5 | CSS3 | JavaScript | PHP </span>
			</div>
		</div>
...
<script>
    var chat_output = $("#chat-body");
	    $("#chat-input-form").on("submit", function(e) {
			...
			$.ajax({
				url: '/profiles/Eniayomi.php', //i will need to change this when pushing
				type: 'POST',
