...
<div class="container" style='color: #3D3D3D'>
    <div class="row justify-content-md-center" style="text-align: center">
        ...
        <div style="padding-top: 30px; padding-bottom: 30px"> 
            ...
            <span style="font-size: 16px; color: grey">Forgot Password?<a href="resetpassword.php" style="color: #008DDD"> Click here</a></span>
        </div>
        
        <div style="padding-bottom: 20px; font-size: 16px; color: #ADADAD">Don't have an account?&nbsp; <a href="signup.php" style="color: #008DDD">Get Started</a></div>
        </div>
    </div>
