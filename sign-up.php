    ...
    <div class="jumbotron signup-jumbotron">
      <div class="container signup ">
          ...
          <div class="col-md-6 pt-0">
            ...
            <div class="form-style"><input  type="text" id="firstName" style="height: 30px;" name="firstName" class="form-control" placeholder="" autofocus required></div>
            </div>

            <div class="input-block pb-2">
            <label class="label" for="lastName">Last Name</label>
            <input type="text" style="height: 30px;" id="lastName" name="lastName" class="form-control" placeholder="" required>
            </div>
            
            <div class="input-block mr-9 pb-2">
            <label class="label" for="userName">Username</label>
            <input type="text" style="height: 30px;" id="userName" name="userName" class="form-control" placeholder="" required>
            </div>

            <div class="input-block pb-2">
            <label class="label" for="email">Email Address</label>
            <input type="email" style="height: 30px;" id="email" name="email" class="form-control" placeholder="" required>
            </div>
            ...
            <select class="form-control" style="height:10%;" name="nationality" id="nationality" required>
...
<!-- <<<<<<< HEAD -->
            ...
            <input type="tel" id="phone" style="height: 30px;" name="phone" class="form-control" placeholder="" required>
<!-- =======
...
>>>>>>> d530f7f4dc913fd97f9de97a0b808cfb28f97970 -->
         ...
         <!--    <div class="input-block mr-9 pb-2">
            ...
            <input type="password" id="password"  style="height: 30px;" name="password" class="form-control" placeholder="" required>
            </div>

            <div class="input-block pb-2">
            <label class="label" for="passwordCheck">Retype Password</label>
            <input type="password" id="passwordCheck"  style="height: 30px;" name="passwordCheck" class="form-control" placeholder="" required>
            </div>
